...
DEFAULT_WORKSPACES: list[dict[str, Any]] = [
    ...
    },
    {
        ...
        "vertical": "Services",
        "workspace_id": os.environ.get("MOENGAGE_SERVICES_WORKSPACE_ID", ""),
        "api_key": os.environ.get("MOENGAGE_SERVICES_API_KEY", ""),
        "data_center": "03",
        "is_active": bool(os.environ.get("MOENGAGE_SERVICES_WORKSPACE_ID")),
    },
    {
        "workspace_name": "Wealth",
        "vertical": "Wealth",
        "workspace_id": os.environ.get("MOENGAGE_WEALTH_WORKSPACE_ID", ""),
        "api_key": os.environ.get("MOENGAGE_WEALTH_API_KEY", ""),
        "data_center": "03",
        "is_active": bool(os.environ.get("MOENGAGE_WEALTH_WORKSPACE_ID")),
    },
    {
